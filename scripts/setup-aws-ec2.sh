...
echo ""
echo "2. Inicie o motor com PM2 dentro da pasta eudorama.com:"
echo "   cd /home/ubuntu/eudorama.com"
echo "   pm2 delete viki-motor 2>/dev/null || true"
echo "   pm2 start \"npx tsx automation-server.ts\" --name \"viki-motor\" --cwd /home/ubuntu/eudorama.com"
echo "   pm2 startup"
echo "   pm2 save"
echo ""
