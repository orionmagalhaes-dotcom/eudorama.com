...
const MOCK_FLOWS: Record<string, SupportFlowStep> = {
    ...
    'viki_tv_sl_code_guide': { id: 'viki_tv_sl_code_guide', message: 'Deixe o código na TV. Pegue o celular.', options: [{ label: 'Samsung', next_step_id: 'viki_tv_samsung_link_action' }, { label: 'LG', next_step_id: 'viki_tv_lg_link_action' }, { label: 'Android TV', next_step_id: 'viki_tv_android_link_action' }] },
    'viki_tv_samsung_link_action': { id: 'viki_tv_samsung_link_action', message: 'Abra este site em guia anônima:', options: [{ label: 'Login Samsung', action: 'link', action_value: 'https://www.viki.com/web-sign-in?return_to=%2Fsamsungtv', next_step_id: 'viki_tv_sl_site_check' }] },
    'viki_tv_lg_link_action': { id: 'viki_tv_lg_link_action', message: 'Abra este site em guia anônima:', options: [{ label: 'Login LG', action: 'link', action_value: 'https://www.viki.com/web-sign-in?return_to=%2Flgtv', next_step_id: 'viki_tv_sl_site_check' }] },
    'viki_tv_android_link_action': { id: 'viki_tv_android_link_action', message: 'Abra este site em guia anônima:', options: [{ label: 'Login Android TV', action: 'link', action_value: 'https://www.viki.com/web-sign-in?return_to=%2Fandroidtv', next_step_id: 'viki_tv_sl_site_check' }] },
    'viki_tv_sl_site_check': { id: 'viki_tv_sl_site_check', message: 'Conseguiu fazer login no site?', options: [{ label: 'Sim', next_step_id: 'viki_tv_sl_login_process' }] },
